...
#define PMD_COMMANDS_OPTIONS                                                   \
  (PMD_COMMANDS_STRING(PMD_OPTION_HELP, ",h"),                                 \
   "help")(PMD_COMMANDS_STRING(PMD_OPTION_DBPATH, ",d"),                       \
           boost::program_options::value<std::string>(),                       \
           "database file full path")(                                         \
      PMD_COMMANDS_STRING(PMD_OPTION_SVCNAME, ",s"),                           \
      boost::program_options::value<std::string>(), "local service name")(     \
      PMD_COMMANDS_STRING(PMD_OPTION_MAXPOOL, ",m"),                           \
      boost::program_options::value<unsigned int>(),                           \
      "max pooled agent")(PMD_COMMANDS_STRING(PMD_OPTION_LOGPATH, ",l"),       \
                          boost::program_options::value<std::string>(),        \
                          "diagnostic log file full path")(                    \
      PMD_COMMANDS_STRING(PMD_OPTION_CONFPATH, ",c"),                          \
      boost::program_options::value<std::string>(),                            \
